     ...
     <div class="row">
         <div class="col-4">
             <div class="form-group">
                 ...
                 <select name="pengaduan" id="pengaduan" class="form-control pengaduan">
             ...
             <?php $no = 1;
                foreach ($pertanyaan as $tanya) : ?>
                 <tr>
                     ...
                     <td><?= $tanya['isi'] ?></td>
                     <td style="width:50px;"><button id="grafik" data-kd_pertanyaan="<?= $tanya['kd_pertanyaan'] ?>" data-kd_pengaduan="<?= $kd_pengaduan ?>" class="btn btn-info grafik"><i class="fas fa-chart-pie"></i></button></td>
                 </tr>
             <?php endforeach; ?>
         </tbody>
     </table>
