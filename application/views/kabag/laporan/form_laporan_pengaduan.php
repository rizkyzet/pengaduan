     ...
     <table class="table table-sm table-hover table-bordered table-striped ">
         <thead>
             <tr class="bg-info text-white">
                 ...
                 <th scope="col" class="text-center">Pengduan</th>
                     ...
                     <td>
                         <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                             <div class="btn-group mr-2" role="group" aria-label="Second group">
                                 <a data-toggle="tooltip" title="Cetak Laporan" data-placement="bottom" href="<?= base_url('kabag/laporan/cetak_lap_pengaduan/' . $png['kd_pengaduan']) ?>" class="btn btn-info"><i class="fas fa-print"></i></a>
