 ...
 <div class="container-fluid">
     ...
     <div class="row mb-3 mt-3">
         <div class="col-5">
             <form class="form-inline" method="POST" action="<?= base_url('kabag/laporan/cetak_lap_saran') ?>">
                 <div class="input-group mb-2 mr-sm-2">
                     <div class="input-group-prepend">
                         <div class="input-group-text">Judul</div>
                     </div>
                     <select name="kd_pengaduan" id="pengaduan_saran_kabag" class="form-control pengaduan">
