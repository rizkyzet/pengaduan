...
class Laporan extends CI_Controller
{
    ...
    public function grafik()
    {
        ...
        $this->load->view('admin/laporan/form_laporan_grafik');
    ...
    public function ajax_table_pertanyaan()
    {
        ...
        $this->load->view('admin/laporan/ajax_table_pertanyaan', $data);
    }
    ...
    public function ajax_grafik()
    {
        ...
        $this->load->view('admin/laporan/ajax_grafik', $data);
    }
    ...
    public function pengaduan()
    {
        ...
        $this->load->view('templates_dashboard/sidebar');
        $this->load->view('templates_dashboard/topbar');
        $this->load->view('admin/laporan/form_laporan_pengaduan');
        $this->load->view('templates_dashboard/footer');
    }
    public function cetak_lap_pengaduan($kd_pengaduan)
    {
        ...
        $html = $this->load->view('admin/laporan/cetak_laporan_pengaduan', $data, true);
    ...
    public function saran()
    {
        ...
        $this->load->view('templates_dashboard/sidebar');
        $this->load->view('templates_dashboard/topbar');
        $this->load->view('admin/laporan/form_laporan_saran');
        $this->load->view('templates_dashboard/footer');
    }
    ...
    public function ajax_saran()
    {
        ...
        $this->load->view('admin/laporan/ajax_table_saran', $data);
    }
    ...
    public function cetak_lap_saran()
    {
        ...
        $html = $this->load->view('admin/laporan/cetak_laporan_saran', $data, true);
