...
class Akun extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('mahasiswa/akun/form_info_akun');
    ...
    public function edit_akun()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates_dashboard/sidebar_mahasiswa');
            $this->load->view('templates_dashboard/topbar');
            $this->load->view('mahasiswa/akun/form_edit_akun');
            $this->load->view('templates_dashboard/footer');
        } else {
            ...
            if ($gambar) {
                ...
                $config['file_name'] = $data['user']['npm'];
    ...
    public function ubah_password()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates_dashboard/sidebar_mahasiswa');
            $this->load->view('templates_dashboard/topbar');
            $this->load->view('mahasiswa/akun/form_ubah_password');
            $this->load->view('templates_dashboard/footer');
        } else {
            ...
            if ($cek_password_lama) {
                ...
                redirect('mahasiswa/akun/ubah_password');
            } else {
